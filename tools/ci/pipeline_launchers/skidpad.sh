...
ros2 launch amzsim_interface amzsim_interface.launch.py \
	discipline_name_arg:=skidpad \
	track_path_arg:=/__w/autonomous_2024/autonomous_2024/install/amzsim_tracks/share/amzsim_tracks/tracks_csv/standard/autocross_trackdrive/FSG.csv \
